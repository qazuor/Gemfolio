...
export const Route = createFileRoute('/_dashboard/mi-cuenta/')({
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Ingresa la URL de tu imagen de perfil.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Así se ve tu perfil</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 text-center text-sm text-muted-foreground">
                <p>Los cambios en tu perfil se</p>
                <p>reflejarán en toda la aplicación.</p>
              </div>
            </CardContent>
          </Card>
        </div>
